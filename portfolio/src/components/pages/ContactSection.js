  ...
  return (
    ...
    >
      <div className="h-2/5 w-full bg-[#fff] px-[2.5em] md:px-[10.5em] z-[-1]">
        ...
        <div className="relative w-[250px] md:w-[1000px] l:w-[1000px] xl:w-[1000px] 2xl:w-[1000px] h-[500px] bg-[#fff] m-auto rounded-md shadow-lg border border-[#adb5bd80] flex z-10">
          <div className="h-full w-full mx-auto md:w-3/5 l:w-3/5 xl:w-3/5 2xl:w-3/5 bg-[#fff] border-r-2 p-4">
