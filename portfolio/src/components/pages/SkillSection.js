...
export default function SkillSection(){
    return (
      <>
        <div className="py-[5rem] z-0 bg-[#fff] w-full h-[70vh] md:h-[90vh] lg:h-[90vh] px-[2em] md:px-[10.5rem]">
          <div className="item-center text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-12">
              <div className="bg-[#fff] border-[.50px] border-[#b2bbc3] p-24 rounded-md text-center hover:text-white hover:bg-[#9b6c9a] hover:duration-500">
                <div>
