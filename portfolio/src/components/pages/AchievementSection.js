...
export default function AchievementSection() {
  return (
    <div className="bg-white h-[auto] md:h-[120vh] lg:h-[auto] py-[5rem] px-0 md:px-[10.5rem] ">
      <div className="item-center text-center mb-10">
        <div>
      ...
      <div className="lg:text-start w-full flex items-center justify-center">
            ...
            <Card sx={{ maxWidth: 345 }} className="shadow-2xl">
              ...
              <CardContent className="bg-[#b37eb5]">
                ...
                <Typography variant="body2" color="text.secondary">
                  The Gawad Karunungan Award is a prestigious recognition
                  bestowed upon an outstanding student in the Bachelor of
                  Science in Financial Management program.
                </Typography>
              </CardContent>
          ...
          <Grid item xs={12} md={4} className="flex justify-center">
            <Card sx={{ maxWidth: 345 }}>
              ...
              <CardContent className="bg-[#b37eb5]">
                ...
                <Typography variant="body2" color="text.secondary">
                  Achieving the title of Overall Top 2 with a remarkable General
                  Weighted Average (GWA) of 1.3125 in the Bachelor of Science in
            ...
            <Card sx={{ maxWidth: 345 }}>
              ...
              <CardContent className="bg-[#b37eb5]">
                ...
                <Typography
                  ...
                  className="font-bold"
                >
                  The "Financial Analysis & Modeling | Automobile Section"
                  course delves into the intricacies of financial analysis and
                  modeling within the context of the automotive industry.
                </Typography>
              </CardContent>
              <CardActions className="bg-[#b37eb5]">
                <a
            ...
            <Card sx={{ maxWidth: 345 }}>
              ...
              <CardContent className="bg-[#b37eb5]">
                ...
                <Typography variant="body2" color="text.secondary">
                  ...
                  broadens horizons and opens doors to unparalleled
                  opportunities.
                </Typography>
              </CardContent>
              <CardActions className="bg-[#b37eb5]">
