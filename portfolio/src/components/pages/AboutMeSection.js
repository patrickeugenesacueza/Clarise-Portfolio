    ...
    <div className="py-5 border-t-[2px] z-0 bg-[#fff] shadow-md w-full h-[auto] md:h-[90vh] lg:h-[90vh] 2xl:[50vh] px-0 text-center md:px-[10.5rem] lg:px-[10.5rem]">
      ...
      <div className="flex flex-col md:flex-row items-start justify-start mt-[4em] md:mt-[5em]">
        ...
        <div className="w-1/2 mx-auto md:text-left md:ml-11 mt-4 md:mt-0">
          ...
          <div className="sm: text-justify font-[sans-serif] text-[auto]">
            ...
            prestigious distinction of Magna Cum Laude.  <br></br><br></br>Throughout my studies, I honed my
            analytical skills, strategic thinking, and financial acumen,
            preparing me to excel in the dynamic world of finance. I am eager to
            leverage my education and skills to contribute meaningfully to the
            financial sector.
          </div>
          <div>
