      ...
      <div className="w-full text-center md:w-1/2 md:text-justify flex flex-col pt-[5em] pb-[6em] md:py-[7em] lg:py-10">
        ...
        <div className="mb-2">
          <button
            ...
            className="px-4 py-2 bg-[#fff] mt-3.5 mr-2 font-bold font-maven text-[#b37eb5] border-2 border-[#b37eb5] rounded-3xl mx-auto hover:bg-[#b37eb5] hover:text-[#fff] duration-500 md:mx-0 md:mr-3 md:text-1 md:px-4 md:py-2  md:rounded-[4em]  2xl:text-l 2xl:px-4 2xl:py-2 2xl:rounded-[4em] "
          >
            CONTACT ME
          </button>
          <a href={resume} download="Resume">
            <button
              className={`buttonload ${
                loading ? "loading" : ""
              } px-4 py-2 bg-[#b37eb5] mt-3.5 font-bold font-maven text-[#fff] rounded-3xl mx-auto border-2 border-[#b37eb5] hover:bg-[#fff] hover:text-[#b37eb5] duration-500 md:mx-0 md:text-1 md:px-4 md:py-2  md:rounded-[4em] 2xl:text-l 2xl:rounded-[4em] relative`}
